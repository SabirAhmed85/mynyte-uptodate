...
class getListingsForFoodFeed extends SprocTest {

  public function get_sproc_name(){
      return "getListingsForFoodFeed";
  }
  public function valid_type(){
    $town_id = 1;    // Bedford
    $sproc_name = $this->get_sproc_name();
    $query = "CALL {$sproc_name}({$town_id})";
    $valid_types = array("STRING","INTEGER","STRING","STRING","STRING","STRING","STRING","STRING","STRING","STRING","STRING","STRING","INTEGER","NOT_NULL_FLAG","STRING","UNIQUE_KEY_FLAG","UNIQUE_KEY_FLAG","STRING","STRING","STRING","STRING","STRING","NOT_NULL_FLAG","INTEGER","INTEGER");
