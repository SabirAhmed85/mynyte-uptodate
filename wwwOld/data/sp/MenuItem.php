<?php
    ...
    elseif ($action == 'updateMenuItemSubCategoryDetailsForBusiness') {
        ...
        print("CALL updateMenuItemSubCategory('$_businessId', '$_menuItemSubCategoryId', '$catName', '$description')");
    }
    ...
    elseif ($action == 'updateMenuItemTemplateOption') {
        ...
        foreach ($optionChoices as $value) {
            ...
            print("UPDATE MenuExtraOptionOption SET Name = '$name', ExtraPrice = '$extraPrice', orderIndex = '$orderIndex' WHERE _id = '$_optionId' AND _menuExtraOptionId = '$_id'");
        }
    }
