<?php
  ...
  elseif ($action == 'makeUserActive') {
      ...
      $_oneSignalDeviceToken = (empty($_GET['_oneSignalDeviceToken'])) ? "": mysql_real_escape_string($_GET['_oneSignalDeviceToken']);
      
      $result = mysql_query("CALL makeUserActive($_profileId,$_oneSignalId, '$_oneSignalDeviceToken')");
  }
